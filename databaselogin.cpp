    ...
    ui(new Ui::DatabaseLogin)
{
    ...
    setWindowTitle(tr("物料消耗管理软件登录"));//设置软件标题
    ...
    QIcon close_icon(":/image/ICON/close.png");//设置按钮图标所在位置
    ...
    ui->closeButton->setStyleSheet("QPushButton:hover{border-image:url(:/image/ICON/red1.png);}");
    //设置鼠标滑过颜色变化


    ui->minButton->setGeometry(300-60,0,30,30);//设置按钮位置和大小
    ui->minButton->setToolTip(tr("最小化"));//设置鼠标放上去后的文字提示
    QIcon min_icon(":/image/ICON/min.png");//设置按钮图标所在位置
    ...
    ui->minButton->setStyleSheet("QPushButton:hover{border-image:url(:/image/ICON/title_h.png);}");
    //设置鼠标滑过颜色变化



    ui->ico_label->setGeometry(100,50,100,100);//设置标签位置大小
    QString path = ":/image/ICON/mysql.png";//设置图标标签所在位置
    ...
    ui->loginBtn->setGeometry(100,300,100,40);//设置按钮的位置和大小
